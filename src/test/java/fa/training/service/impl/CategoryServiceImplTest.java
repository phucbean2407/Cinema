...
public class CategoryServiceImplTest {
    ...
    void deleteCategory() {
        ...
        //When
        when(categoryRepository.findById(test.getId())).thenReturn(Optional.of(test));
        //Then
        Boolean actual = categoryService.deleteCategory(test.getId());
        verify(categoryRepository).deleteById(test.getId());
    ...
    void deleteCategoryFalse() {
        ...
        //When
        when(categoryRepository.findById(test.getId())).thenReturn(Optional.empty());
        //Then
        Boolean actual = categoryService.deleteCategory(test.getId());
        assertEquals(expected,actual);
    }
